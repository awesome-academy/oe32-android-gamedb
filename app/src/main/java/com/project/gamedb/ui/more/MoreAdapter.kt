...
class MoreAdapter (private val OnClickFragmentListener: OnClickFragmentListener.Details) : BaseAdapter<Games>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Games> {
        ...
        return MoreViewHolder(view, OnClickFragmentListener)
    }
}
